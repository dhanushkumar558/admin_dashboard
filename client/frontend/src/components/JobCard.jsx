...
const JobCard = ({ job }) => {
  ...
  <div className="d-flex align-items-center gap-1">
    <span dangerouslySetInnerHTML={{
      __html: `<svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="d-flex align-items-center gap-1">
    <span dangerouslySetInnerHTML={{
      __html: `<svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="d-flex align-items-center gap-1">
    <span dangerouslySetInnerHTML={{
      __html: `<svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
